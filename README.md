...
- **seq16** - 4-pattern, 16-step pitch sequencer with draggable semitone steps (`-24..24`), per-step velocity bars, global length (`1-16`), and trigger-advanced pattern playback (`1 -> 2 -> 3 -> 4 -> 1`).
