...
- **drum seq** - 4-lane, 4-pattern, 16-step trigger sequencer with 808-style per-step toggles, per-pattern length (`1-16`), cycle span (`1-4`), and four trigger outputs for drum/sample voices. Reset snaps to step 1 and immediately emits that step's triggers.
